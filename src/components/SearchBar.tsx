  ...
  return (
    <div className={`relative ${className}`}>
      <div className="relative group">
        {/* Icône de recherche */}
        <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 transition-colors duration-smooth w-5 h-5 group-focus-within:text-primary" style={{ color: '#6b7280' }} />
